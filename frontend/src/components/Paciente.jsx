...
const Paciente = ({paciente}) => {
    ...
    const {email, nombre, rut, contacto, emailcontacto, fecha, hora, sintomas, _id} =paciente
    ...
    return (
        <div className="my-10 bg-white shadow-sm px-5 py-10 rounded-xl">
            ...
            <p className="font-bold uppercase color-title">Hora: {'  '} 
                <span className="font-normal normal-case text-[#2f2f2f]">
                    {hora}
                </span>
            </p>
            ...
            <div className="flex justify-between my-5">
                ...
                onClick={() => setEdicion(paciente)}>Modificar</button>
                <button type="button" className="py-2 px-4 md:px-10 bg-red-600 hover:bg-red-800 text-white uppercase font-bold rounded-lg" onClick={() => eliminarPaciente(_id)}>Eliminar</button>
